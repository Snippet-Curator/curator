...
docker-curator:
  docker build -t kangruixiang/curator:0.0.10 ./curator
  docker tag kangruixiang/curator:0.0.10 kangruixiang/curator:latest
  docker push kangruixiang/curator:0.0.10
