...
docker-curator:
  docker build -t kangruixiang/curator:0.0.25 ./curator
  docker tag kangruixiang/curator:0.0.25 kangruixiang/curator:latest
  docker push kangruixiang/curator:0.0.25
