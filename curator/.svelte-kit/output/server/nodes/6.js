...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/note/_slug_/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/scroll-area.bHHIbcsu.css","_app/immutable/assets/FilterSearch.Bfnm9isJ.css"];
export const fonts = [];
