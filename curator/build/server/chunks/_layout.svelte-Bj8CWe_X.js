import { Y as stringify, Z as spread_props, _ as bind_props, $ as ensure_array_like, a0 as attributes, a1 as attr_class, a2 as clsx, a3 as sanitize_props, a4 as slot, a5 as derived, a6 as await_block, a7 as attr } from './index-DFk0vKPb.js';
import { p as page, g as goto } from './index2-BlJ4z0wj.js';
import { s as setTagState, a as setNotebookState, b as setMobileState, c as setSettingState, d as setMouseState, e as getTagState, f as getNotebookState, h as getMobileState, i as getSettingState, j as getMouseState, k as cn } from './utils2-vPAmPu5P.js';
import { S as StyleToObject, c as createSubscriber, a as Scroll_area } from './scroll-area-4udoZtyH.js';
import { c as clsx$1 } from './clsx-ChV9xqsO.js';
import { t as tick } from './EditNote.svelte_svelte_type_style_lang-N4Cf3Uss.js';
import { C as Command_dialog, a as Command_input, b as Command_list, c as Command_empty, d as Command_group, e as Command_item, S as Search, A as Archive, T as Trash_2, s as snapshot } from './Delete-CCIhHOHZ.js';
import { q as hasContext, u as getContext, s as setContext } from './exports-Cug9_qxt.js';
import { I as Icon$1 } from './Icon-CiAOWcym.js';
import { N as Notebook } from './notebook-PosgQq5g.js';
import { T as Tags } from './tags-DAIgStR6.js';
import { I as Import } from './import-5qmMT6WS.js';
import { e as escape_html } from './escaping-CqgfEcN3.js';
import { R as Root, T as Trigger, C as Context_menu_content, a as Context_menu_item } from './index3-Dby5GV8o.js';
import { T as Tag } from './tag-h51GbcUy.js';
import { N as NotebookList_1, T as TagList_1 } from './ChangeParent-BjQ4AUiI.js';
...
function bar($$renderer, item) {
  ...
  $$renderer.push(`<button${attr_class(clsx(page.url.hash == item.url ? "dock-active" : ""))}>`);
      ...
      children: ($$renderer3) => {
        $$renderer3.push(`<!---->`);
        {
          let renderBottomPages = function($$renderer4, name, url, icon) {
            const Icon2 = icon;
            $$renderer4.push(`<li><a${attr_class(clsx(page.url.pathname == url ? "menu-active" : ""))}${attr("href", url)}><!---->`);
...
//# sourceMappingURL=_layout.svelte-Bj8CWe_X.js.map
