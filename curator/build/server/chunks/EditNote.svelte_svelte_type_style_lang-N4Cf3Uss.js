import { w as watch, C as Context, b as createBitsAttrs, e as boxWith, s as simpleBox, n as styleToString, f as SvelteMap, D as DOMContext, o as executeCallbacks, p as composeHandlers, q as contains, u as useId, g as attachRef, r as getWindow$1, t as boxFrom, v as getDocument, x as isWritableSymbol, B as BoxSymbol, m as mergeProps, y as defaultWindow, z as isFunction, A as boxFlatten, E as toReadonlyBox, F as isBox, G as isWritableBox, c as createSubscriber, k as getDataOpenClosed, h as boolToEmptyStrOrUndef, j as boolToStr, H as cssToStyleObj } from './scroll-area-4udoZtyH.js';
import { B as getAllContexts } from './exports-Cug9_qxt.js';
import { aa as on, ab as lifecycle_function_unavailable, a5 as derived, Z as spread_props } from './index-DFk0vKPb.js';
...
class ContextMenuTriggerState {
  ...
  #clearLongPressTimer() {
    ...
    getWindow$1(this.opts.ref.current).clearTimeout(this.#longPressTimer);
  }
  #handleOpen(e) {
  ...
  onpointerdown(e) {
    ...
    this.#clearLongPressTimer();
    this.#longPressTimer = getWindow$1(this.opts.ref.current).setTimeout(() => this.#handleOpen(e), 700);
  }
  onpointermove(e) {
    if (this.opts.disabled.current || isMouseEvent(e)) return;
    this.#clearLongPressTimer();
...
export { CONTEXT_MENU_TRIGGER_ATTR as $, ARROW_UP as A, F12 as B, CAPS_LOCK as C, BACKSPACE as D, ENTER as E, Floating_layer as F, PAGE_UP as G, HOME as H, PAGE_DOWN as I, END as J, next as K, prev as L, META as M, forward as N, backward as O, PresenceManager as P, getFloatingContentCSSVars as Q, RovingFocusGroup as R, SPACE as S, TAB as T, afterSleep as U, isIOS as V, isElement$1 as W, MenuRootState as X, MenuMenuState as Y, ContextMenuTriggerState as Z, MenuContentState as _, afterTick as a, MenuItemState as a0, MenuSeparatorState as a1, Focus_scope as a2, Escape_layer as a3, Dismissible_layer as a4, Text_selection_layer as a5, Scroll_lock as a6, getFirstNonCommentChild as a7, h as a8, k as a9, p as aa, l as ab, j as ac, n as ad, srOnlyStyles as ae, Portal as b, Floating_layer_anchor as c, Popper_layer_force_mount as d, Popper_layer as e, ESCAPE as f, ARROW_DOWN as g, ARROW_LEFT as h, ARROW_RIGHT as i, SHIFT as j, CONTROL as k, ALT as l, F1 as m, noop as n, F2 as o, F3 as p, F4 as q, F5 as r, srOnlyStylesString as s, tick as t, F6 as u, F7 as v, F8 as w, F9 as x, F10 as y, F11 as z };
//# sourceMappingURL=EditNote.svelte_svelte_type_style_lang-N4Cf3Uss.js.map
